...
const wordsDatabase = {
    ...
    "Biblico": ["BIBLIA", "ALTAR", "SANSON", "DANIEL", "NABUCONODOSOR", "APOCALIPSIS", "DAVID", "ESPIRITU", "JESUCRISTO", "JERUSALEN", "MIGUELANGEL", "SAMUEL", "ISAIAS", "MATEO", "CULTO", "ORACION", "AMOR", "DALILA", "REYES", "CORINTIOS"],
    "Deportes": ["FÚTBOL", "BALONCESTO", "NATACIÓN", "TENIS", "ATLETISMO", "CICLISMO", "VOLEIBOL", "GOLF", "BOXEO", "JUDO"],
    "Objetos": ["COMPUTADORA", "TELEFONO", "LIBRETA", "ESCRITORIO", "VENTANA", "PANTALLA", "TECLADO", "SILLA", "MESA", "LÁMPARA","BATERIA", "MICROFONO"]
};
